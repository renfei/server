package net.renfei.server.search.service;
...
import net.renfei.server.search.api.service.SearchService;
import net.renfei.server.search.repository.SearchRepository;
...
import static net.renfei.server.search.api.entity.SearchItem.INDEX_COORDINATES;
